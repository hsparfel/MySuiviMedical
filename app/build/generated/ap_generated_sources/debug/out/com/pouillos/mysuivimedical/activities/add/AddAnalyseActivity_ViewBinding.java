...
public class AddAnalyseActivity_ViewBinding implements Unbinder {
  private AddAnalyseActivity target;

  private View view7f0800bb;

  @UiThread
  public AddAnalyseActivity_ViewBinding(AddAnalyseActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AddAnalyseActivity_ViewBinding(final AddAnalyseActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AddAnalyseActivity target = this.target;
