...
public class AfficherRdvExamenActivity_ViewBinding implements Unbinder {
  private AfficherRdvExamenActivity target;
  ...
  @UiThread
  public AfficherRdvExamenActivity_ViewBinding(AfficherRdvExamenActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherRdvExamenActivity_ViewBinding(final AfficherRdvExamenActivity target,
      View source) {
    this.target = target;
    ...
    target.layoutExamen = Utils.findRequiredViewAsType(source, R.id.layoutExamen, "field 'layoutExamen'", TextInputLayout.class);
    target.textExamen = Utils.findRequiredViewAsType(source, R.id.textExamen, "field 'textExamen'", TextInputEditText.class);
  ...
  @CallSuper
  public void unbind() {
    AfficherRdvExamenActivity target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.selectedRdv = null;
    target.listRdv = null;
    target.layoutExamen = null;
    target.textExamen = null;
