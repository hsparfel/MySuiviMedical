...
public class ImportEtablissementActivity_ViewBinding implements Unbinder {
  private ImportEtablissementActivity target;
  ...
  @UiThread
  public ImportEtablissementActivity_ViewBinding(ImportEtablissementActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ImportEtablissementActivity_ViewBinding(final ImportEtablissementActivity target,
      View source) {
    this.target = target;

    View view;
    target.nbEtablissementImported = Utils.findRequiredViewAsType(source, R.id.nbEtablissementImported, "field 'nbEtablissementImported'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    ImportEtablissementActivity target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.nbEtablissementImported = null;
