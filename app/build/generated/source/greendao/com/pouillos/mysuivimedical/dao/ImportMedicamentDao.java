...
/** 
 * DAO for table "IMPORT_MEDICAMENT".
*/
public class ImportMedicamentDao extends AbstractDao<ImportMedicament, Long> {

    public static final String TABLENAME = "IMPORT_MEDICAMENT";

    /**
     * Properties of entity ImportMedicament.<br/>
    ...
    public ImportMedicamentDao(DaoConfig config) {
        super(config);
    }
    
    public ImportMedicamentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"IMPORT_MEDICAMENT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"IMPORT_MEDICAMENT\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ImportMedicament entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ImportMedicament entity) {
        stmt.clearBindings();
    ...
    @Override
    public ImportMedicament readEntity(Cursor cursor, int offset) {
        ImportMedicament entity = new ImportMedicament( //
    ...
    @Override
    public void readEntity(Cursor cursor, ImportMedicament entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ImportMedicament entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ImportMedicament entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ImportMedicament entity) {
