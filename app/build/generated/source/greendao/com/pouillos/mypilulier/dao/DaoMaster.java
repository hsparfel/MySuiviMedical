...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        AlarmRdvDao.createTable(db, ifNotExists);
        AssociationAlarmRdvDao.createTable(db, ifNotExists);
        ...
        RappelDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        AlarmRdvDao.dropTable(db, ifExists);
        AssociationAlarmRdvDao.dropTable(db, ifExists);
        ...
        RappelDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AlarmRdvDao.class);
        registerDaoClass(AssociationAlarmRdvDao.class);
        ...
        registerDaoClass(RappelDao.class);
    }
